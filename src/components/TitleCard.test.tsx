...
describe('TitleCard Component', () => {
  it('renders the title', () => {
    render(<TitleCard isSpring={false} isSummer={false} isAutumn={false} isWinter={false} />);
    expect(screen.getByText('What Boston Season Is It?')).toBeInTheDocument();
  });

  it('applies spring class when isSpring is true', () => {
    render(<TitleCard isSpring={true} isSummer={false} isAutumn={false} isWinter={false} />);
  ...
  it('applies summer class when isSummer is true', () => {
    render(<TitleCard isSpring={false} isSummer={true} isAutumn={false} isWinter={false} />);
  ...
  it('applies autumn class when isAutumn is true', () => {
    render(<TitleCard isSpring={false} isSummer={false} isAutumn={true} isWinter={false} />);
  ...
  it('applies winter class when isWinter is true', () => {
    render(<TitleCard isSpring={false} isSummer={false} isAutumn={false} isWinter={true} />);
